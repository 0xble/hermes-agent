...
def build_gemini_request(
    *, messages: List[Dict[str, Any]], tools: Any = None, tool_choice: Any = None, temperature: Optional[float] = None,
    ...
    model: str = "", response_format: Any = None, tools_as_json_schema: bool = False,
) -> Dict[str, Any]:
    ...
    generation = (
        ...
        ("responseMimeType", response_mime_type), ("responseJsonSchema", response_json_schema),
    )
...
class GeminiNativeClient:
    ...
    def _create_chat_completion(
        ...
        top_p: Optional[float] = None, stop: Any = None, response_format: Any = None,
