...
class ClientLifecycleMixin:
    ...
    def _try_refresh_codex_client_credentials(self, *, force: bool = True) -> bool:
        # A named child never re-resolves singleton/pool credentials mid-run: it is
        # pinned to the credential it launched with, and adopting freshly resolved
        # tokens would silently move it onto another account behind the pin. The
        # parent's refresh is what authorizes a new child after expiration.
    ...
    def _swap_credential(self, entry) -> None:
        ...
        close_request_client = getattr(self, "_close_cached_request_openai_client", None)
