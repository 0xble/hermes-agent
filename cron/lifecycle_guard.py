    ...
    *,
    ...
    for script_path, referenced_shell_context in referenced_scripts:
        ...
        if remote:
            ...
            # Never read more than the walk can still afford to tokenize; a
            # file larger than the remainder fails closed like an oversized one.
        ...
        child_shell_context = bool(referenced_shell_context) or _script_declares_shell(
            script_text
        )
        if _contains_unsafe_gateway_action(
            script_text,
