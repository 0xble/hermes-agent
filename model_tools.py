...
def _execute_tool(function_name: str, function_args: Dict[str, Any], original_args: Dict[str, Any], ids: _CallIds,
                  *, user_task: Optional[str], goal_control_revision: Optional[int],
                  enabled_tools: Optional[List[str]], skip_tool_execution_middleware: bool) -> Any:
    ...
    if function_name == "execute_code":
        ...
        dispatch_kwargs["turn_id"] = ids.turn_id
        dispatch_kwargs["goal_control_revision"] = goal_control_revision
...
def handle_function_call(
    ...
    api_request_id: Optional[str] = None, user_task: Optional[str] = None,
    goal_control_revision: Optional[int] = None, enabled_tools: Optional[List[str]] = None,
    ...
    if bridged is not None:
        ...
        return handle_function_call(
            *underlying, **asdict(ids), user_task=user_task, goal_control_revision=goal_control_revision,
