...
- **Regression:** `scripts/run_tests.sh tests/hermes_cli/test_telegram_namespace.py tests/hermes_cli/test_telegram_user.py tests/hermes_cli/test_telegram_topic_icons.py tests/gateway/test_telegram_user_policy.py tests/gateway/test_telegram_user_transport.py tests/gateway/test_telegram_custom_topic_icons.py tests/gateway/test_telegram_topic_icon_runtime.py tests/gateway/test_telegram_topic_icon_service.py tests/agent/test_title_generator.py tests/gateway/test_session_title_rename_lane.py tests/gateway/test_telegram_topic_mode.py tests/test_hermes_state.py tests/test_telegram_topic_status_ptb.py -q`. Live release proof requires attended identity authorization, exact disposable topic mutation/readback/cleanup, and two unique cases per configured Apple pack with zero default IDs or readback mismatches.
