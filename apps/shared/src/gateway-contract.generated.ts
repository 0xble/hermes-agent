...
export interface BackendGatewayEventMap {
  ...
  /** The parent began handling a delegated child's result. */
  'subagent.handling': SubagentEventPayload
  /** Batched tool-name progress from a child. */
  'subagent.progress': SubagentEventPayload
  /** A delegated result entered the parent's result turn. */
  'subagent.result_turn': SubagentEventPayload
