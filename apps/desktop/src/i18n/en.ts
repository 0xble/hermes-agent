...
export const en: Translations = {
  ...
  cron: {
    ...
    timezonePlaceholder: 'Profile timezone (inherited)',
    timezoneHint: 'Optional IANA zone for cron wall-clock schedules, such as America/New_York.',
    timezoneInherited: 'Profile timezone (inherited)',
    explicit: 'explicit',
