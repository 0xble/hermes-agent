...
export const ar = defineLocale({
  ...
  cron: {
    ...
    timezonePlaceholder: 'المنطقة الزمنية للملف الشخصي (موروثة)',
    timezoneHint: 'منطقة IANA اختيارية لجداول cron حسب التوقيت المحلي، مثل America/New_York.',
    timezoneInherited: 'المنطقة الزمنية للملف الشخصي (موروثة)',
    explicit: 'صريحة',
