...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("topic", "Enable or inspect Telegram DM topic sessions", "Session",
               gateway_only=True, args_hint="[off|help|edit|session-id]",
               subcommands=("edit", "off", "help")),
    ...
    CommandDef("branch", "Branch the current session (new thread on Discord/Telegram/Slack/Matrix; --here stays here)",
               "Session", aliases=("fork",), args_hint="[--here] [name]", busy_policy="defer_until_idle"),
    ...
    CommandDef("whoami", "Show your slash command access (admin / user)", "Info", busy_policy="dispatch"),
    ...
    CommandDef("reasoning", "Manage reasoning effort and display", "Configuration",
               ...
               subcommands=("none", "minimal", "low", "medium", "high", "xhigh", "max", "ultra", "show", "hide", "on", "off", "full", "clamp", "--global"), busy_policy="dispatch"),
    ...
    CommandDef("usage", "Show token usage and rate limits; `reset` redeems a banked Codex limit reset", "Info",
               args_hint="[reset [--force]]", busy_policy="dispatch"),
