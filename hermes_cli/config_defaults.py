...
DEFAULT_CONFIG = {
    ...
    "telegram": {
        ...
        "extra": {
            "rich_messages": "auto",   # Bot API 10.1 rich messages: auto (adaptive, default), always, or never.
            "rich_drafts": False,       # Experimental Bot API 10.1 rich draft previews during Telegram DM streaming; opt in per profile.
        },
    },
