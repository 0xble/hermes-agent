...
class CLIChatTurnMixin:
        ...
        with notification_policy_snapshot(agent, "cli", notification_config_snapshot()):
            ...
            try:
                ...
                agent_thread = threading.Thread(
                    target=self._chat_run_agent,
                    args=(turn, message, internal_goal_continuation), daemon=True)
                agent_thread.start()
    ...
    def _chat_run_agent(self, turn, message, internal_goal_continuation: bool = False):
        ...
        _turn_reasoning_config = getattr(self, "_pending_turn_reasoning_config", None)
