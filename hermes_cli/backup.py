...
_EXCLUDED_SUFFIXES = (
    ...
    ".db-shm",
    ".db-journal",
    # Opaque client-session databases are bearer credentials, not portable
    # profile state. Exclude the root and SQLite sidecars generically so retired
    # or third-party transports cannot leak authorization material into archives.
    ".session",
    ".session-wal",
    ".session-shm",
    ".session-journal",
