...
| Telegram paragraph spacing | `tests/gateway/test_telegram_rich_newlines.py` | Own contribution: [upstream PR 100686](https://github.com/NousResearch/hermes-agent/pull/100686) for [issue 100664](https://github.com/NousResearch/hermes-agent/issues/100664), open at `7b7ab064752947fd7576d59aa0d028a127f57e8d` on 2026-09-19. Rich Message prose paragraph breaks become one NBSP spacer row; structural blocks stay raw. Contract in [Telegram rendering](telegram-rendering.md). |
