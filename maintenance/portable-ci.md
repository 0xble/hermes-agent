...
| `tests.yml` | `python`: canonical `scripts/run_tests.sh tests candidate-extensions`. `e2e`: canonical `scripts/run_tests.sh tests/e2e`. Integration and Docker directories stay excluded from the ordinary Python lane. |
