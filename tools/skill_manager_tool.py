...
def skill_manage(
    ...
    # Shared skills are parent-owned: a delegated child proposes changes back
    # rather than mutating them. Checked before the batch shape so `operations`
    # cannot route around the deny.
