...
class TestBackgroundDispatch:
    def test_dispatches_and_returns_handle_immediately(self):
        ...
        try:
            ...
            m_claim.assert_called_once_with("job-bg-01", force=True, preserve_paused=True, manual=True, return_job=True)
...
class TestCronjobRunToolIntegration:
    ...
    def test_run_action_sync_path_unchanged_without_session(self):
        ...
        m_claim.assert_called_once_with("job-bg-13", force=True, preserve_paused=True, manual=True, return_job=True)
