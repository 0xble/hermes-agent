...
run stamps per command (HERMES_DELEGATED_CHILD_CONTEXT, HERMES_CRON_SESSION), and
the cron run's authority markers (HERMES_CRON_ALLOW_MESSAGING / JOB_ID), or the
parent's next command is misread as that child (#90782, #71941).
"""
