...
def test_openwakeword_ensures_base_models_for_custom_path(monkeypatch):
    ...
    # This case specifically covers an ONNX model. Exercise it through our
    # platform-policy seam rather than inheriting the macOS ARM64 tflite
    # default (where ONNX is intentionally unsupported, openWakeWord #336).
