...
def test_quickstart_runs_all_three_legs(client, capable_hardware, quickstart_hardware_ready,
...
def test_quickstart_skips_satisfied_legs(client, capable_hardware, quickstart_hardware_ready, monkeypatch):
...
@pytest.fixture
def quickstart_hardware_ready(monkeypatch):
    """Make hardware and engine preflight deterministic on hosted runners."""
...
@pytest.fixture
def quickstart_ready(monkeypatch, quickstart_hardware_ready):
