...
def test_quickstart_runs_all_three_legs(client, quickstart_hardware_ready, monkeypatch, tmp_path):
...
def test_quickstart_skips_satisfied_legs(client, quickstart_hardware_ready, monkeypatch):
