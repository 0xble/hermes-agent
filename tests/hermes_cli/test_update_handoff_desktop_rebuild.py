...
def test_handoff_venv_repair_finishes_node_and_web_phase(tmp_path, defer_completion):
    ...
    with (
        ...
        complete = update_cmd._repair_venv_on_current_checkout(
            ...
            print_completion=deferred if defer_completion else None,
        )
    ...
    if defer_completion:
        deferred.assert_called_once_with("✓ Update complete!")
