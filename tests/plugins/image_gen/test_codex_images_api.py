...
def test_images_gateway(monkeypatch, editing):
    ...
    assert plugin._collect_image_b64("test-key", prompt="circle", size="1024x1024", quality="medium", input_images=[{"image_url": "fixture"}] if editing else None, base_url="http://localhost/v1", gateway=True, api_mode="images") == {"b64": "result", "source": "final"}
