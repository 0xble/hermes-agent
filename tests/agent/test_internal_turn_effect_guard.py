...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("set_goal", {"action": "resume", "user_requested": True}),
        ("set_goal", {"action": "set", "user_requested": True}),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("set_goal", {"action": "pause"}),
        ("set_goal", {"action": "resume"}),
        ("set_goal", {"action": "clear"}),
        ("set_goal", {"action": "set", "goal": "Continue authorized work"}),
