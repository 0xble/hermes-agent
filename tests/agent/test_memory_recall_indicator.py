...
"🧠 Recalled N memories" status line so the user SEES memory
...
def test_zero_count_renders_generic():
    ...
    assert mgr.describe_recall() == "💭 Recalled relevant memory"
...
def test_aggregates_multiple_providers():
    ...
    assert "💭 Recalled 5 memories" in result
