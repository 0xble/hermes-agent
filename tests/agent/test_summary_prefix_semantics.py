...
_FROZEN_PREFIX_GENERATIONS = (
    ...
    (
        ...
        "deprioritize memory content due to this compaction note. None of "
        "the above restricts HOW you work: your tools remain fully active — "
        "keep calling them normally for the active task (edit files, run "
        "commands, search) instead of merely narrating what you would do. "
...
# regression below. Index 2 after the #80622 and reference-only-memory
# freezes were prepended.
