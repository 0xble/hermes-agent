...
def test_slash_review_dispatches_under_the_parent_session_identity(monkeypatch):
    ...
    # The fork renders this notice as "⚖ Review dispatched{starting_note}. …"; upstream's new
    # test was written against upstream's own wording.
    assert out == "⚖ Review dispatched. Results will return here."
