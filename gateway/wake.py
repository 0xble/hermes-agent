...
async def _self_post_chat_completion(adapter: Any, *, text: str, session_id: str) -> None:
    ...
    headers = {
        ...
        # Preserve synthetic-turn authority across the non-push HTTP bridge; without it the
        # API adapter sees an ordinary authenticated user turn.
        "X-Hermes-Internal-Notification": str(
            getattr(adapter, "_internal_notification_token", "")),
    }
