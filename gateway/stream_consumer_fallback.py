...
class StreamFallbackMixin:
    ...
    async def _suppress_silence_marker(self) -> None:
        ...
        cleanup_succeeded = await self._delete_previews(
            self._stale_preview_ids(), label="Silence-marker")
        ...
        if cleanup_succeeded:
            ...
            self._confirm_pending_preview_boundary(
                ...
                message_id=(str(self._message_id)
                            if self._message_id and self._message_id != "__no_edit__" else None))
