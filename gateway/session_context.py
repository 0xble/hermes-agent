...
_CRON_ALLOW_MESSAGING: ContextVar = ContextVar("HERMES_CRON_ALLOW_MESSAGING", default=_UNSET)
_CRON_JOB_ID: ContextVar = ContextVar("HERMES_CRON_JOB_ID", default=_UNSET)
_CRON_RUN_ID: ContextVar = ContextVar("HERMES_CRON_RUN_ID", default=_UNSET)
_CRON_FIRE_OWNER: ContextVar = ContextVar("HERMES_CRON_FIRE_OWNER", default=_UNSET)
...
_VAR_MAP = {
    ...
    "HERMES_CRON_ALLOW_MESSAGING": _CRON_ALLOW_MESSAGING,
    "HERMES_CRON_JOB_ID": _CRON_JOB_ID,
    "HERMES_CRON_RUN_ID": _CRON_RUN_ID,
    "HERMES_CRON_FIRE_OWNER": _CRON_FIRE_OWNER,
}
