...
_TOPLEVEL_BRIDGE: tuple = (
    ...
    *_presence(
        ...
        "filter_silence_narration", "restart_resume_policy",
    ),
...
def read_yaml_layers(home: Path) -> dict:
    ...
    # Preserve authored-layer route precedence before merging preset references.
    # Defaults remain absent and malformed user YAML still raises here.
