...
CREATE TABLE IF NOT EXISTS async_delegations (
    ...
    delivery_recovery_attempts INTEGER NOT NULL DEFAULT 0,
    parent_task_id TEXT,
    thread_number INTEGER,
    task_label TEXT,
    owner_json TEXT
);
CREATE TABLE IF NOT EXISTS delegation_thread_counters (
    owner_json TEXT PRIMARY KEY, next_thread_number INTEGER NOT NULL
);
CREATE TABLE IF NOT EXISTS delegation_parent_tasks (
    parent_task_id TEXT PRIMARY KEY, owner_json TEXT NOT NULL
);
