...
Named `delegation.subagents.<name>` roles also accept `model_preset`; expansion happens before
launch snapshots are frozen. Later config edits do not reroute resumed children. Fork MoA
